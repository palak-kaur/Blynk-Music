...
//    }); // End of search button
    ...
    $(".search-nav").click(function(e){
        if(!isSearchOpen){
         ...
         $(".search-bar").css({"height":" 5vh","width":"50vw","border":"0.5px solid grey", "color":"grey", "border-radius": "25px", "display":"flex", "justify-content":"center", "align-items":"center", "margin": "30px 80px 30px 30px" });
